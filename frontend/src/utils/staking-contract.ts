...
const stakeToken = async (amount: string) => {
        ...
        functionCalls: [
            {
                ...
                args: {
                    receiver_id: config.VBI_STAKING_CONTRACT,
                    amount,
                    msg: ""
                },
                gas: "60000000000000",
    ...
    //@ts-ignore
    let storageStatus: string = await stakingContract.storage_balance_of({ account_id: wallet.getAccountId() });
